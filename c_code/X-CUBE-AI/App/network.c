...
#define AI_NETWORK_MODEL_SIGNATURE     "6c8eda782fa7351b4d0380ae4d78738d"
...
#define AI_TOOLS_DATE_TIME   "Wed Jan  5 18:57:48 2022"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_conv2d_7_input0_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Array#18 */
AI_ARRAY_OBJ_DECLARE(
  dense_13_weights_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 216, AI_STATIC)

/* Array#19 */
AI_ARRAY_OBJ_DECLARE(
  dense_13_bias_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 4, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  serving_default_conv2d_7_input0_output, AI_STATIC,
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 32, 32), AI_STRIDE_INIT(4, 4, 4, 4, 128),
  1, &serving_default_conv2d_7_input0_output_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  14, 0x0,
  AI_SHAPE_INIT(4, 16, 5, 5, 10), AI_STRIDE_INIT(4, 4, 64, 320, 1600),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  16, 0x0,
  AI_SHAPE_INIT(4, 10, 54, 1, 1), AI_STRIDE_INIT(4, 4, 40, 2160, 2160),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  18, 0x0,
  AI_SHAPE_INIT(4, 54, 4, 1, 1), AI_STRIDE_INIT(4, 4, 216, 864, 864),
  1, &dense_13_weights_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_conv2d_7_input0_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 6432, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_conv2d_7_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_14_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    serving_default_conv2d_7_input0_output_array.data = AI_PTR(NULL);
    serving_default_conv2d_7_input0_output_array.data_start = AI_PTR(NULL);
    conv2d_0_output_array.data = AI_PTR(activations_map[0] + 384);
    conv2d_0_output_array.data_start = AI_PTR(activations_map[0] + 384);
    nl_3_output_array.data = AI_PTR(activations_map[0] + 384);
    nl_3_output_array.data_start = AI_PTR(activations_map[0] + 384);
    conv2d_4_output_array.data = AI_PTR(activations_map[0] + 0);
    conv2d_4_output_array.data_start = AI_PTR(activations_map[0] + 0);
    nl_7_output_array.data = AI_PTR(activations_map[0] + 1600);
    nl_7_output_array.data_start = AI_PTR(activations_map[0] + 1600);
    conv2d_8_output_array.data = AI_PTR(activations_map[0] + 0);
    conv2d_8_output_array.data_start = AI_PTR(activations_map[0] + 0);
    dense_11_output_array.data = AI_PTR(activations_map[0] + 40);
    dense_11_output_array.data_start = AI_PTR(activations_map[0] + 40);
    nl_12_output_array.data = AI_PTR(activations_map[0] + 256);
    nl_12_output_array.data_start = AI_PTR(activations_map[0] + 256);
    dense_13_output_array.data = AI_PTR(activations_map[0] + 0);
    dense_13_output_array.data_start = AI_PTR(activations_map[0] + 0);
    nl_14_output_array.data = AI_PTR(NULL);
    nl_14_output_array.data_start = AI_PTR(NULL);
    ...
    conv2d_4_scratch0_array.data = AI_PTR(activations_map[0] + 5152);
    conv2d_4_scratch0_array.data_start = AI_PTR(activations_map[0] + 5152);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(weights_map, 1, params)) {
    ...
    conv2d_4_weights_array.data = AI_PTR(weights_map[0] + 624);
    conv2d_4_weights_array.data_start = AI_PTR(weights_map[0] + 624);
    conv2d_4_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_bias_array.data = AI_PTR(weights_map[0] + 10224);
    conv2d_4_bias_array.data_start = AI_PTR(weights_map[0] + 10224);
    conv2d_8_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_8_weights_array.data = AI_PTR(weights_map[0] + 10288);
    conv2d_8_weights_array.data_start = AI_PTR(weights_map[0] + 10288);
    conv2d_8_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_8_bias_array.data = AI_PTR(weights_map[0] + 26288);
    conv2d_8_bias_array.data_start = AI_PTR(weights_map[0] + 26288);
    dense_11_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_11_weights_array.data = AI_PTR(weights_map[0] + 26328);
    dense_11_weights_array.data_start = AI_PTR(weights_map[0] + 26328);
    dense_11_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_11_bias_array.data = AI_PTR(weights_map[0] + 28488);
    dense_11_bias_array.data_start = AI_PTR(weights_map[0] + 28488);
    dense_13_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_13_weights_array.data = AI_PTR(weights_map[0] + 28704);
    dense_13_weights_array.data_start = AI_PTR(weights_map[0] + 28704);
    dense_13_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_13_bias_array.data = AI_PTR(weights_map[0] + 29568);
    dense_13_bias_array.data_start = AI_PTR(weights_map[0] + 29568);
    return true;
  }
  return false;
}
